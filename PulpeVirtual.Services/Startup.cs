...
namespace PulpeVirtual.Services
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient(typeof(PulpeVirtualDataContext));
            services.AddTransient<CategoryAppService>();

            services.AddDbContext<PulpeVirtualDataContext>(options => {
                options.UseSqlServer(Configuration.GetConnectionString("PulpeVirtualDataContext"));
            });
        }
